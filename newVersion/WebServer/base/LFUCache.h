...
class ListNode {
public:
    void setPre(ListNode* p) { pre_ = p; }
    void setNext(ListNode* p) { next_ = p; }
    ListNode* getPre() { return pre_; }
    ListNode* getNext() { return next_; }
...
typedef ListNode<KeyList>* freq_node;
